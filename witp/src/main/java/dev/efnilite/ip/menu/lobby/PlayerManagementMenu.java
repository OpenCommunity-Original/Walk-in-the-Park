...
public class PlayerManagementMenu {
    ...
    public void open(Player p) {
        ...
        PagedMenu menu = new PagedMenu(3, Locales.getString(viewer.player, "lobby.player_management.name"));
    ...
    private void add(PagedMenu menu, ParkourUser viewer, Collection<ParkourUser> users) {
        ...
        for (ParkourUser other : users) {
            ...
            Item item = Locales.getItem(viewer.player, "lobby.player_management.head", other.getName());
            ...
            if (muted) {
                // add top
                lore.addAll(List.of(Locales.getString(viewer.player, "lobby.player_management.head.top").split("\\|\\|")));
            }

            // add bottom
            lore.addAll(List.of(Locales.getString(viewer.player, "lobby.player_management.head.bottom").split("\\|\\|")));
